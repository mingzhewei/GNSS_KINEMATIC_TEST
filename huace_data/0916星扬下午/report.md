...
|------|------|------|------|----------------------|
| 跟踪卫星数 | 50.7 | 38 | 55 | #SVs跟踪到的卫星数(M7手册BESTP字段15/p83) |
| 可用卫星数 | 44.7 | 36 | 48 | #solnSVs参与解算的卫星数(M7手册BESTP字段16/p84) |
...
| 卫星数(跟踪/参与解算) | 通过 | 平均跟踪50.7颗，平均参与解算44.7颗，良好 |
