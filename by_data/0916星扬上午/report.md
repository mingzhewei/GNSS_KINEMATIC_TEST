...
## 基本信息
- **分析输入(COM3/ASCII)**: 0916星扬上午.dat
- **生成时间**: 2026-09-17 19:23:53
...
**数据完整性**: 158208 条有效报文(原始 306968 行, 乱码残片 0 行)
...
|------|------|------|------|----------------------|
| 跟踪卫星数 | 42.1 | 13 | 48 | BESTGNSSPOSA #SVs跟踪到的卫星数(UG016 4.2.2字段15) |
| 可用卫星数 | 41.7 | 4 | 47 | BESTGNSSPOSA #solnSVs参与解算的卫星数(UG016 4.2.2字段16) |
...
| 评估指标 | 状态 | 说明 |
|---------|------|------|
        | GNSS固定解比率 | 警告 | 83.3%，基本满足要求 |
| INS固定解比率 | 失败 | 17.8%，需要改善 |
| 卫星数(跟踪/参与解算) | 通过 | 平均跟踪42.1颗，平均参与解算41.7颗，良好 |
| DOP值 | 通过 | 平均HDOP 0.65，优秀 |
